 ...
 * |--------+------+------+------+------+------| spc  |           |      |------+------+------+------+------+--------|
 * |Esc/MEH |A/MDIA|   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |  ;   | '/Symb |
 * |--------+------+------+------+------+------| Symb |           | Meh  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |  /   | LShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1| Ctrl | NUMP | Lalt |Sp/LGu|                                       | LGui |</LGui|  v   |  ^   |   >  |                  
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Vol- | Vol+ |       | Pause| Next   |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV),KC_LCTL,       MO(NUMP),         KC_LALT,        GUIT_T(KC_SPC),
                                                                                 KC_VOLD,KC_VOLU,
                                                                                         KC_MUTE,
        ...
        // right hand
             ...
             MEH_T(KC_NO),KC_N,   KC_M,    KC_COMM,       KC_DOT, KC_SLSH,          KC_LSFT,
                                  KC_LGUI, GUI_T(KC_LEFT),KC_DOWN,KC_UP,            KC_RIGHT,
             KC_MPLY,        KC_MNXT,      
             KC_MPRV,
             RESET,  KC_ENT, KC_SPC
    ),
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_TRNS,KC_TRNS,KC_LBRC,KC_RBRC,LSFT(KC_DOT), KC_TRNS,
       ...
       KC_TRNS, KC_CIRC, KC_7,   KC_8,    KC_9,    KC_PIPE, KC_PLUS,
                KC_AMPR, KC_4,   KC_5,    KC_6,    KC_COLN, KC_TRNS,
