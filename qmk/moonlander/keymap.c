...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_LEFT,                                        KC_RIGHT,       KC_6,           KC_7,           KC_8,           KC_9,           KC_UNDS,        KC_EQUAL,       
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           LGUI(KC_SPACE),                                 OSM(MOD_HYPR),  KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_MINUS,       
    KC_ESCAPE,      KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_HYPR,                                                                        KC_MEH,         KC_H,           KC_J,           KC_K,           KC_L,           ST_MACRO_0,     KC_QUOTE,       
    KC_LSHIFT,      MT(MOD_LCTL, KC_Z),KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         LT(1,KC_SLASH), KC_RSHIFT,      
    LT(1,KC_GRAVE), KC_LCTRL,       TT(3),          KC_LALT,        KC_LGUI,        MT(MOD_LALT, KC_APPLICATION),                                                                                                OSL(2),         OSL(1),         MT(MOD_RGUI, KC_LEFT),KC_DOWN,        KC_UP,          KC_RIGHT,       
    KC_BSPACE,      KC_F24,         KC_LGUI,                        KC_MEDIA_PLAY_PAUSE,KC_ENTER,       KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
