...
(let ((base00 "#1d1f21")
  ...
  (custom-theme-set-faces
   ...
   `(helm-header ((t (:background ,base06 :underline nil))))
   `(helm-match ((t (:foreground ,base0A))))
   `(helm-moccur-buffer ((t (:foreground ,base0C))))
   `(helm-selection ((t (:background ,base06))))
   `(helm-selection-line ((t (:foreground nil :background ,base06))))
   `(helm-separator ((t (:foreground ,base02))))
   `(helm-source-header ((t (:background ,base03 :weight bold))))
